...
export default function LandingReplica() {
  return (
    <div className="relative min-h-screen bg-white text-[#1A1A1A]">
      ...
      <header className="relative z-10">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-6 lg:px-8">
          <div className="flex items-center gap-3">
            <Image
              src="/logo-difficult-conversations.svg"
          ...
          <nav className="hidden items-center gap-6 text-sm font-medium text-neutral-700 md:flex">
            ...
            <Link className="hover:underline" href="#initiatives">
              Initiatives
            </Link>
            <Link className="hover:underline" href="#listen">
              Podcast
            </Link>
          </nav>
        </div>
      ...
      <section className="relative z-10">
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 px-6 pb-8 pt-6 md:grid-cols-2 lg:px-8 lg:pb-14 lg:pt-12">
          <div className="order-2 md:order-1">
            <p className="mb-3 text-sm font-medium tracking-wide text-neutral-600">
              KYND Presents:
            </p>
            <h1 className="text-balance text-4xl font-black tracking-[-0.02em] text-[#1A1A1A] sm:text-5xl lg:text-6xl">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 py-10 md:grid-cols-2 lg:px-8 lg:py-16">
          ...
          <div className="space-y-5 text-[15px] leading-7 text-neutral-800">
            <p className="font-medium text-neutral-900">
              Which “landmark” historical event happened without difficult
              conversations?
            </p>
            <p className="text-[17px] font-semibold">
              Every peace, every justice did.
            </p>
            <div className="space-y-3">
              <p className="font-semibold">Mission Statement:</p>
              <p>
                To lead a culture of healthy disagreements; to help people build
                emotional maturity and resilience; to depolarize local
                communities; to help learn negotiation and de-escalation
                tactics; and to call world leaders to action on issues that have
                been put off because they were considered “too polarizing.”
              </p>
            </div>
            <div className="space-y-3">
              <p className="font-semibold">Vision Statement:</p>
              <p>
                To create a world where difficult conversations don’t feel so
                difficult.
              </p>
            </div>
          </div>
      ...
      <section
        id="initiatives"
        className="relative z-10 mt-6 bg-[#121212] py-12 text-white"
      >
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4">
            ...
            <IconTile
              ...
              label="Authoring to Authority"
              href="#"
            />
            <IconTile
              icon={<Instagram className="h-8 w-8" />}
              label="Perspective Exchange Blog"
              href="#"
            />
          </div>
